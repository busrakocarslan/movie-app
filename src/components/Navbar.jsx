...
function classNames(...classes) {// clasları birleştirmek için kullanılan bir fonksiyon
...
export default function Navbar() {
  ...
  return (
    ...
    <div className="w-[60px]"></div></React.Fragment>// fixedin sıkıntısını kaldırmssk için navbar kadar boş bir div kurduk
  );
}
